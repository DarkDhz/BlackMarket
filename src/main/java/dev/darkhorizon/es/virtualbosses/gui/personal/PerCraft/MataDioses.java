...
public class MataDioses extends PersonalGUI {
    ...
    public MataDioses(Player target) {
        super(45, "§0§l✦ §dMata Dioses §0§l✦", target.getUniqueId());
    ...
    public boolean manageClick(Player target, ItemStack clicked, String title, int slot) {
        ...
        if (Comparators.validateItem(clicked, commonItems.getCraft())) {
            target.getInventory().addItem(giveItems.getMataDioses());
