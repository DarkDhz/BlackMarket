...
public class EspacialBoots extends PersonalGUI {
    ...
    public EspacialBoots(Player target) {
        super(45, "§0§l✦ §6Botas Espaciales §0§l✦", target.getUniqueId());
    ...
    public boolean manageClick(Player target, ItemStack clicked, String title, int slot) {
        ...
        if (Comparators.validateItem(clicked, commonItems.getCraft())) {
            target.getInventory().addItem(giveItems.getArmaduraEspacialBoots());
