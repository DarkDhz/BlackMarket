...
public class EspacialLeggings extends PersonalGUI {
    ...
    public EspacialLeggings(Player target) {
        super(45, "§0§l✦ §6Pantalones Espaciales §0§l✦", target.getUniqueId());
    ...
    public boolean manageClick(Player target, ItemStack clicked, String title, int slot) {
        ...
        if (Comparators.validateItem(clicked, commonItems.getCraft())) {
            target.getInventory().addItem(giveItems.getArmaduraEspacialLeggings());
