...
public class EspacialChestPlate extends PersonalGUI {
    ...
    public EspacialChestPlate(Player target) {
        super(45, "§0§l✦ §6Peto Espacial §0§l✦", target.getUniqueId());
    ...
    public boolean manageClick(Player target, ItemStack clicked, String title, int slot) {
        ...
        if (Comparators.validateItem(clicked, commonItems.getCraft())) {
            target.getInventory().addItem(giveItems.getArmaduraEspacialChestPlate());
