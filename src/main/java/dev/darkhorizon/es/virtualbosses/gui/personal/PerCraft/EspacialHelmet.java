...
public class EspacialHelmet extends PersonalGUI {
    ...
    public EspacialHelmet(Player target) {
        super(45, "§0§l✦ §6Casco Espacial §0§l✦", target.getUniqueId());
    ...
    public boolean manageClick(Player target, ItemStack clicked, String title, int slot) {
        ...
        if (Comparators.validateItem(clicked, commonItems.getCraft())) {
            target.getInventory().addItem(giveItems.getArmaduraEspacialHelmet());
